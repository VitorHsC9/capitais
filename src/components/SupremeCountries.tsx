import { ArrowLeft, Search, Globe, Clock, Map } from 'lucide-react';
        ...
        return (
            <div className="flex flex-col h-full items-center justify-center p-6 animate-in fade-in duration-500">
                ...
                <p className="text-[var(--text-secondary)] font-medium mb-8 text-center max-w-xs">
                    Você conseguiu dominar <span className="text-blue-600 font-bold">{progress}</span> de <span className="text-[var(--text-primary)] font-bold">{totalCountries}</span> países.
                </p>
        ...
        <div className="flex flex-col h-full animate-in fade-in duration-500 relative">
            ...
            <div className="flex flex-col gap-4 mb-4 z-10 relative bg-[var(--bg-color)] pb-4 pt-4 px-4 border-b border-[var(--border-color)] shadow-sm">
                ...
                <div className="relative group">
                    <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-[var(--text-secondary)] group-focus-within:text-blue-500 transition-colors">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-4 rounded-xl bg-[var(--surface-color)] border-2 border-[var(--border-color)] text-[var(--text-primary)] font-bold placeholder:text-[var(--text-secondary)] focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all uppercase tracking-wider"
                        autoFocus
                    />
                </div>
            </div>
