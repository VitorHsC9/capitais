        ...
        <div className="flex flex-col h-full animate-in fade-in duration-300">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-center">
                    <h2 className="text-xs font-bold uppercase tracking-widest text-[var(--tone-2)]">Desafio Diário</h2>
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-6">
                ...
                <div className="relative w-full max-w-[320px]">
                    ...
                    {isFinished && (
                        <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-[var(--bg-color)] px-4 py-1 rounded-full border border-[var(--tone-4)] shadow-lg flex items-center gap-2 whitespace-nowrap">
                            {gameStatus === 'won' ? (
                                <>
                                    <CheckCircle className="w-4 h-4 text-[var(--color-correct)]" />
                                    <span className="text-xs font-bold text-[var(--color-correct)]">VOCÊ ACERTOU!</span>
                                </>
                            ) : (
                                <>
                                    <XCircle className="w-4 h-4 text-[var(--color-error)]" />
                                    <span className="text-xs font-bold text-[var(--color-error)]">NÃO FOI DESSA VEZ</span>
                                </>
                            )}
                        </div>
                    )}
                ...
                <div className="text-center w-full px-4">
                    {isFinished ? (
                        <div className="bg-[var(--tone-5)] p-6 rounded-xl border border-[var(--tone-4)] animate-in slide-in-from-bottom-4 duration-500">
                            <p className="text-xs text-[var(--tone-3)] uppercase font-bold mb-2">País de Hoje</p>
                            <h1 className="text-3xl font-black text-[var(--tone-1)] mb-6">{targetCountry.name}</h1>
                        ...
                        <div className="space-y-2">
                            <h2 className="text-xl font-bold text-[var(--tone-1)]">Que país é esse?</h2>
